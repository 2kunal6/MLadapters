...
| MultiTaskLassoRegression | from MLalgorithms.Regression._MultiTaskLasso import  MultiTaskLasso    |(alpha=1.0, *, fit_intercept=True, normalize=False, copy_X=True, max_iter=1000, tol=0.0001, warm_start=False, random_state=None, selection='cyclic') |fit(X, y), predict(X)|
